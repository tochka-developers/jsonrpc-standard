...
namespace Tochka\JsonRpc\Standard\Tests\Units\Support;
...
use Tochka\JsonRpc\Standard\Support\MiddlewareRegistry;
use Tochka\JsonRpc\Standard\Tests\Stubs\FakeBarMiddleware;
use Tochka\JsonRpc\Standard\Tests\Stubs\FakeFooMiddleware;
use Tochka\JsonRpc\Standard\Tests\Stubs\FakeMiddlewareInterface;
use Tochka\JsonRpc\Standard\Tests\Units\DefaultTestCase;

/**
 * @covers \Tochka\JsonRpc\Standard\Support\MiddlewareRegistry
 */
class MiddlewareRegistryTest extends DefaultTestCase
{
    ...
    {
        $foo = \Mockery::mock('FooMiddleware', FakeMiddlewareInterface::class);
        $bar = \Mockery::mock('BarMiddleware', MiddlewareInterface::class);

        $this->registry->appendMiddleware($foo, 'foo');
        $this->registry->appendMiddleware($bar, 'foo');

        $actual = $this->registry->getMiddleware('foo', FakeMiddlewareInterface::class);
    ...
    public function testAddMiddlewaresFromConfig(): void
    {
        ...
        $this->registry->addMiddlewaresFromConfig('foo', $config);
